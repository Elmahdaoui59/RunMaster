package com.running.analytics.presentation
...
import com.running.analytics.presentation.components.AnalyticsCard
        ...
        if (state == null) {
            ...
            Column(
                ...
                Row(
                    ...
                    AnalyticsCard(
                        title = stringResource(id = R.string.faster_ever_run),
