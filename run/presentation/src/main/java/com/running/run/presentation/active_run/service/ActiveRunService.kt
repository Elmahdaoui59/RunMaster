package com.running.run.presentation.active_run.service
...
import com.running.core.presentation.designsystem.R
...
class ActiveRunService: Service() {
    ...
    private val baseNotification by lazy {
        NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            ...
            .setContentTitle(getString(com.running.run.presentation.R.string.active_run))
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannel(
            CHANNEL_ID,
            getString(com.running.run.presentation.R.string.active_run),
